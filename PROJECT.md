...
| 8 | Refactor to Vosk STT | Refactor | Done | `app/transcriber.py`, `build.sh`, `requirements.txt` | G1, G2, G3 | Switched to Vosk to drastically speed up Russian transcription on CPU |
